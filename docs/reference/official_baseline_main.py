# =============================================================================
# FROZEN ORGANIZER BASELINE — reference only, NOT our submission entry point.
#
# This is the organizers' original monolithic baseline (their shipped `main.py`),
# kept VERBATIM for diff / benchmark / feature-parity reference. It uses the
# STALE 2-class Task-2 vocabulary {游资, 量化机构} and the old 11-dim binary
# scorer — both superseded by our Rev. 7 3-class {游资, 量化, 散户} pipeline.
# Do NOT run this as a submission; our entry point is the repo-root `main.py`.
# See README "Repository layout" for when to diff against this file.
# =============================================================================
"""
================================================================================
